...
# remove sys.path modifications; package imports will be handled via emotion namespace
...
from emotion.utils.activations import Hardswish, SiLU
from emotion.utils.general import colorstr, check_img_size, check_requirements, file_size, set_logging
from emotion.utils.torch_utils import select_device
